...
<body>
  <main>
    ...
    <section id="cardPanel" class="panel card hidden" aria-live="polite">
      ...
      <div class="section">
        ...
        ></textarea>
        <div class="answer-score-actions">
          <button id="ruleScoreAnswerButton" class="answer-score-button" type="button">规则评分</button>
  ...
  <script>
    ...
    const elements = {
      ...
      ruleScoreAnswerButton: document.querySelector("#ruleScoreAnswerButton"),
    ...
    function setButtonsDisabled(disabled, activeRating = null) {
      ...
      elements.ruleScoreAnswerButton.disabled = disabled || state.scoring;
    ...
    async function scoreCurrentAnswer(mode = "rule") {
      ...
      const activeButton = mode === "ai"
        ...
        : elements.ruleScoreAnswerButton;
      const originalText = activeButton.textContent;
      state.scoring = true;
      elements.ruleScoreAnswerButton.disabled = true;
      elements.aiScoreAnswerButton.disabled = true;
      activeButton.textContent = mode === "ai" ? "AI评分中..." : "规则评分中...";
      ...
      try {
        ...
        showError(`${mode === "ai" ? "AI评分" : "规则评分"}失败：${error.message}`);
      } finally {
        state.scoring = false;
        elements.ruleScoreAnswerButton.disabled = false;
    ...
    elements.ruleScoreAnswerButton.addEventListener("click", () => scoreCurrentAnswer("rule"));
